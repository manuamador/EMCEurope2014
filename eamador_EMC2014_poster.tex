...
\begin{figure}
     ...
     \subfigure[$f=20$ MHz, $ka=0.4$, $D\approx 1.6$]{
          \label{fig_800M}      
          \includegraphics[trim=110 170 90 180,clip,width=0.48\columnwidth]{./img/rp_4.png}} 
    \subfigure[$f=100$ MHz, $ka=2.1$, $D\approx 2.3$]{
          \label{fig_2G}
   	  \includegraphics[trim=110 170 90 180,clip,width=0.48\columnwidth]{./img/rp_24.png}}\\
\subfigure[$f=500$ MHz, $ka=10.5$, $D\approx 5.2$]{
    ...
    \subfigure[$f=1000$ MHz, $ka=21.0$, $D\approx 5.7$]{
          \label{fig_2G}
          \includegraphics[trim=110 180 90 180,clip,width=0.48\columnwidth]{./img/rp_249.png}}
\vspace{-0.3cm}
...
\begin{figure}
    ...
    \subfigure[4~GHz]{
     ...
     \vspace{-0.3cm}
\large{\caption{Radiation pattern (CST simulations).}}
     \label{fig_diagsCST}
\end{figure}
\end{block}
      %-- Block 2-3
